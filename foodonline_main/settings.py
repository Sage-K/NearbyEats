...
STATICFILES_DIRS = [BASE_DIR / 'foodonline_main/static']  # Custom static files directory (if needed)
...
DEFAULT_FROM_EMAIL = 'Food Online Marketplace <muronzimudzimba@gmail.com>' 
